...
一. 编码规范
   ...
   2. 变量名，方法名用Camel大小写，首字母小写。如：myVar
   
   3. 包名全部小写。如：com.yipeng.framework
   
   4. 常量名全部大写，单词之间以下划线分隔。如:ROLE_VIP
   
   5. 代码缩进，统一采用4个空格，不用TAB字符。
   
   6. 大括号与if,else,for,do,while语句一起使用，即使只有一条语句或是空，也
   ...
   9. 用于划分语句块的小括号、大括号前后留一个空格，但函数调用的小括号
